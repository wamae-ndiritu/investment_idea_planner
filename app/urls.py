...
urlpatterns = [
    ...
    path('investment-ideas/<int:idea_id>/start-planning', views.create_investment_plan,
         name='create_investment_plan'),
    path('investment-plans/', views.list_investment_plans,
         name='investment_plans'),
    path('investment-plans/<int:plan_id>/details', views.view_investment_plan,
         name='view_investment_plan'),
    path('investment-plans/<int:plan_id>/set-reminder', views.set_savings_reminder,
         name='set_savings_reminder'),
